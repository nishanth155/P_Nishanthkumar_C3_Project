...
public class RatingsService {
	...
	public void submitRatings(Rating rating){
		...
		Rating saved = ratingsRepository.save(rating);

		String doctorId = saved.getDoctorId();

		Doctor getDetails = Optional.of(doctorRepository.findById(doctorId)).get().get();

		getDetails.setRating((double) rating.getRating());

		doctorRepository.save(getDetails);
